...
<div id="survey-wrapper">
    <header>
        ...
        <button id="addOneQuestion" class="small-btns ui-box-shadow" title="Lägg till en fråga">
            <img src="../includes/img/add.png" no-repeat>
        </button>
        <!--<label for="removeOneQuestion" class="standard-label">Ta bort en fråga</label>-->
        <button id="removeOneQuestion" class="small-btns ui-box-shadow" title="Ta bort en fråga">
            <img src="../includes/img/delete.png" no-repeat>
        </button>
        <button id="lock-survey" class="small-btns ui-box-shadow" title="Lås enkät">
