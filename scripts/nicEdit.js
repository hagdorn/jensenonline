...
var nicEditorConfig = bkClass.extend({
	buttons : {
		'bold' : {name : __('Fet text'), command : 'Bold', tags : ['B','STRONG'], css : {'font-weight' : 'bold'}, key : 'b'},
		'italic' : {name : __('Kursiv text'), command : 'Italic', tags : ['EM','I'], css : {'font-style' : 'italic'}, key : 'i'},
		'underline' : {name : __('Understruken text'), command : 'Underline', tags : ['U'], css : {'text-decoration' : 'underline'}, key : 'u'},
		'left' : {name : __('Vänsterjustera text'), command : 'justifyleft', noActive : true},
		'center' : {name : __('Centrera text'), command : 'justifycenter', noActive : true},
		'right' : {name : __('Högerjustera text'), command : 'justifyright', noActive : true},
		'justify' : {name : __('Marginaljustera text'), command : 'justifyfull', noActive : true},
		'ol' : {name : __('Infoga numererad lista'), command : 'insertorderedlist', tags : ['OL']},
		'ul' : 	{name : __('Infoga onumererad lista'), command : 'insertunorderedlist', tags : ['UL']},
		'subscript' : {name : __('Subscript'), command : 'subscript', tags : ['SUB']},
		'superscript' : {name : __('Superscript'), command : 'superscript', tags : ['SUP']},
		'strikethrough' : {name : __('Genomstruken text'), command : 'strikeThrough', css : {'text-decoration' : 'line-through'}},
		'removeformat' : {name : __('Radera formatering'), command : 'removeformat', noActive : true},
		'indent' : {name : __('Indentera text'), command : 'indent', noActive : true},
		'outdent' : {name : __('Radera indentering'), command : 'outdent', noActive : true},
		'hr' : {name : __('Horisontel linje'), command : 'insertHorizontalRule', noActive : true}
	},
